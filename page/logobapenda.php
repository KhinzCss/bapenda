...
<body>
    ...
    <section class="pagesejarah">
        <div class="sejarahcont">
            <p class="judul">Logo Bapenda</p>
            <div class="logobapenda">
                <!-- <img src="https://bapenda.bandungbaratkab.go.id/storage/uploads/1691561896WhatsApp Image 2023-08-07 at 10.50.26.jpeg" alt=""> -->
            </div>
